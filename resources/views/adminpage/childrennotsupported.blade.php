    ...
    <div class="bg-white py-20">
        ...
        <div class="content">
            ...
            <h1
                ...
                Support More Children Overview</h1>
                ...
                <div class="grid grid-cols-4 grid-flow-col gap-2 pb-2">
                    ...
                    <div id="dropdown5" class="z-10 hidden w-1/6 p-3 bg-[#212228] rounded-lg">
                        <ul id="dropdown5" class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                            ...
                            <li class=" flex items-center">
                                <input id="school_{{$items['school']}}" type="checkbox" name="school_filters[]" value="{{$items['school']}}"
                                ...
                                <label for="school_{{$items['school']}}"
                    ...
                    <div id="dropdown6" class="z-10 hidden w-1/6 p-3 bg-[#212228] rounded-lg">
                        <ul id="dropdown6" class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                            @foreach($data as $items)
                            <li class=" flex items-center">
                                <input id="location_{{$items['location']}}" type="checkbox" name="location_filters[]" value="{{$items['location']}}"
                    ...
                    <a href='childrensupported'>
                        <div class="bg-red-700 py-3 rounded-lg text-center text-lg">Children has supported</div>
                    </a>
                    <button type="submit">
