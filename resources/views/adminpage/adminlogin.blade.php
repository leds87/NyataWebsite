    ...
    <div class="bg-[#f8f5f2]">
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="max-w-lg my-10 border-2 border-slate-800 rounded-xl mx-auto p-5 shadow-md">
                ...
                @else
                    <div class="text-md bg-red-300 border-black border-solid border-2 rounded-lg text-center w-1/2 mx-auto">
                        {{ Session::get('gagal') }}</div>
                @endif
                ...
                <button type="submit"
                    class="block mx-auto bg-black text-white px-10 py-2 rounded-full hover:scale-125 mt-5">Login</button>
            </div>
        </form>
