                                                    ...
                                                    <tr class="border-b dark:border-neutral-500">
                                                        ...
                                                        <td class="whitespace-nowrap px-6 py-4">
                                                            <button type="button"
                                                                class="bg-green-600 text-white px-2 py-2 rounded-lg"> <a
                                                                    href="/useredit%{{ $item->id }}">Edit</a> </button>
                                                            <form action="{{ route('destroyuser', $item->id) }}"
                                                        ...
                                                        <td>
                                                            <button class="bg-black px-2 py-2 rounded-xl text-white"
                                                                ...
                                                                data-modal-toggle="static-modal{{$item->id}}">Change Password</button>

                                                            <form action="/changepassworduser%{{ $item->id }}"
                                                                method="POST" class="">
                                                                @csrf
                                                                @method('PUT')
