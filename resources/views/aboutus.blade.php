...
<section class="flex relative max-w-none w-full h-[500px]">
    <div
        ...
        <div class="px-12 max-w-screen-xl text-center mx-auto py-36 md:py-40 md:px-24 lg:py-20 lg:px-32 xl:py-28 animated animatedFadeInUp fadeInUp">
...
<section class="text-center max-w-none w-full bg-white py-16">
    ...
    <p class="text-black content-body px-8 pt-4 max-w-[1100px] mx-auto md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1200px]">
...
<section class="text-center max-w-none w-full bg-white py-16">
    ...
    <button type="button" class="px-3 py-2 my-8 bg-[#ff0000] text-xl rounded-[10px] uppercase w-[200px] mx-auto" onclick="window.location='{{ route('aboutus') }}'">
